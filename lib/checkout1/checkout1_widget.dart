    ...
    return Scaffold(
      ...
      body: Align(
        ...
        child: AuthUserStreamWidget(
          builder: (context) => StreamBuilder<List<CarsRecord>>(
            stream: queryCarsRecord(
              queryBuilder: (carsRecord) => carsRecord.where(
                'name',
                isEqualTo: valueOrDefault(currentUserDocument?.activeCar, ''),
              ),
              singleRecord: true,
            ),
            builder: (context, snapshot) {
              ...
              final columnCarsRecord = columnCarsRecordList.isNotEmpty
                  ? columnCarsRecordList.first
                  : null;
                      ...
                      child: Padding(
                        ...
                        child: StreamBuilder<List<CarsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<CarsRecord> containerCarsRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final containerCarsRecord =
                                containerCarsRecordList.isNotEmpty
                                                                      ...
                                                                      text:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          TextSpan(
                                                                            text:
                                                                                valueOrDefault<String>(
                                                                              containerCarsRecord?.transmission,
                                                                              'na',
                                                                            ),
                                                                            style:
                                                                                TextStyle(),
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        decoration:
                                                          ...
                                                          hintText:
                                                              'Input Address of delivery here.',
                                                          hintStyle:
                                                              FlutterFlowTheme.of(
                                                                      context)
                                                                  .labelMedium
                        ...
                        onPressed: () async {
                          await HistoryRecord.collection
                              ...
                              .set(createHistoryRecordData(
                                ...
                                price: functions.newCustomFunction(
                                    _model.countControllerValue,
                                    columnCarsRecord?.price),
                                card: _model.textController3.text,
                                car: columnCarsRecord?.name,
                                date: _model.calendarSelectedDay?.end,
                                image: columnCarsRecord?.image,
                              ));
