...
class _CarListWidgetState extends State<CarListWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarListModel());
  }
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                await currentUserReference!
                                  ...
                                  activeCar: listViewCarsRecord.name,
                                ));
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                listViewCarsRecord.transmission,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 8.0, 4.0, 8.0),
                                          child: Text(
                                            listViewCarsRecord.price.toString(),
                                            textAlign: TextAlign.end,
                                            style: FlutterFlowTheme.of(context)
                                                .titleLarge
                                                .override(
